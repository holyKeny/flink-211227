 ...
 */
public class Flink_Project_App_NoByChannel {
    public static void main(String[] args) throws Exception {
        ...
        //2.从自定义源获取数据
        DataStreamSource<MarketingUserBehavior> streamSource = env.addSource(new Flink_Project_App_ByChannel.AppMarketingDataSource());
